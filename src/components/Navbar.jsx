        ...
        >
          <div className="sidebar-link">
            <div className="sidebar-link-image">
              <Image
                src={
                  activeIndex === index ? value.image.fill : value.image.nonfill
                }
                width={44}
                height={0}
                alt="Logo"
            ...
            <div className="sidebar-link-title">{value.name}</div>
          </div>
        </div>
      </Link>
    ));
          ...
          <Link href="/upload">
            ...
            >
              <div className="sidebar-link">
                ...
                <div className="sidebar-link-title">Upload</div>
              </div>
            </button>
          </Link>
          <Upload
            ...
            <Link href="/profile">
              <div className="sidebar-link">
                ...
                <div className="avatar-name-container">
                  <div className="avatar-name">huge burger</div>
                  <div className="avatar-handle">@hugeburger</div>
                </div>
              </div>
            </Link>
          </div>
